...
public class ActivityHost {
    ...
    private static final String ACTIVITIES_TASK_LIST = "HelloSwfAct5.0";
    ...
    public static void main(String[] args) throws Exception {
        ...
        worker.addActivitiesImplementation(unloadAct);
        worker.addActivitiesImplementation(emrAct);
        worker.addActivitiesImplementation(loadAct);
        
//        SyncActivities syncAct = new SyncActivitiesImpl();
        
//        worker.addActivitiesImplementation(syncAct);
